...
namespace Application.Controllers
{
    ...
    public class PessoasController : ControllerBase
    {
        ...
        [Authorize("Bearer")]
        [HttpPost]
        public async Task<ActionResult> Post([FromBody] PessoaDtoCreate dtoCreate)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            try
            {
                ...
                if (result != null)
                {
                    return Created(new Uri(Url.Link("GetPessoaWithId", new { id = result.Id })), result);
                }
                else
                {
                    return BadRequest();
        ...
        [Authorize("Bearer")]
        [HttpPut]
        public async Task<ActionResult> Put([FromBody] PessoaDtoUpdate dtoUpdate)
        {
